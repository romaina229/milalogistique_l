    ...
    public function checkPaymentStatus(string $reference): array
    {
        ...
        if ($transaction->status === 'paid') {
            ...
            if ($download && $download->isValid()) {
                ...
                $result['download_url']     = rtrim(env('https://milalogistique.vercel.app/', config('app.url')), '/') . '/download-success?token=' . $download->token;
                ...
                $result['download_url']   = rtrim(env('https://milalogistique.vercel.app/', config('app.url')), '/') . '/download-success?token=' . $token;
            }
            $result['document'] = [
